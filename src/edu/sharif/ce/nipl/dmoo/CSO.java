...
public class CSO {
	...
	private static List<Double> TrueAccs = new ArrayList<Double>();
	...
	public static void main(String[] args) throws Exception {
		...
		finalResult.put("TrueAcc", new Double (0));
		...
		List<Double> TrueAccList = new ArrayList<Double>(zero);
		...
		allMeasures.put("TrueAcc", TrueAccList);
		...
		for(int cycle = 0 ; cycle < NUMCYCLE ; cycle++){
			...
			TrueAccs.add(result.get("TrueAcc"));
			finalResult.put("TrueAcc", finalResult.get("TrueAcc") + result.get("TrueAcc"));
	...
	private static void printFinalVarianceMeans() {
		...
		System.out.println("True Acc : " + getVariance(TrueAccs) );
	...
	private static void write(Map<String, List<Double>> allMeasures) throws IOException {
		...
		// True Acc
		List<Double> trueAccMainList = allMeasures.get("TrueAcc");
		for(int i = 0 ; i < trueAccMainList.size() ; i++){
			trueAccMainList.set(i, trueAccMainList.get(i) / NUMCYCLE);
		}
		...
		writemeasure("TrueAcc" , trueAccMainList);
	...
	private static void addListToMeasures( Map<String, List<Double>> allMeasures, Map<String, List<Double>> measures) {
		...
		// ACC True
		List<Double> trueAccMainList = allMeasures.get("TrueAcc");
		List<Double> trueAccList = measures.get("TrueAcc");
		for(int i = 0 ; i < trueAccList.size() ; i++){
			trueAccMainList.set(i, trueAccMainList.get(i) + trueAccList.get(i));
		}
		...
		allMeasures.put("TrueACC", trueAccMainList);
	...
	private static void printFinalMeanResult(Map<String, Double> finalResult) {
		...
		System.out.println("True Acc : " + finalResult.get("TrueAcc")/ NUMCYCLE);
